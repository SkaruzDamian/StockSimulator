...
class AgentResultsWindow:
    def __init__(self, parent, agent_simulation):
        self.parent = parent
    ...
    def show(self):
        ...
        self.window.title("Wyniki Symulacji Agenta")
    ...
    def create_widgets(self):
        ...
        ttk.Label(main_frame, text="Wyniki Symulacji Agenta", font=("Arial", 16, "bold")).pack(pady=(0, 20))
    ...
    def create_overview_chart(self, parent):
        performance_data = self.agent_simulation.agent_portfolio.daily_portfolio_value
        ...
        ax.fill_between(dates, values, self.agent_simulation.trading_simulator.initial_capital, alpha=0.3, color='#1f77b4')
        ax.axhline(y=self.agent_simulation.trading_simulator.initial_capital, color='red', linestyle='--', linewidth=2, label='Kapitał początkowy')
    ...
    def create_ticker_charts(self, parent):
        ...
        transactions = self.agent_simulation.agent_portfolio.transaction_history
